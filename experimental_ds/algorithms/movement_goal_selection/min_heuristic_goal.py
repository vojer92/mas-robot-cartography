...
class MinHeuristicGoal(MovementGoalSelectionMethod):
    """
    Selects the movement goal from a list of movement goals with the minimal heuristic value.
    Depending on the used heuristic it is the nearest, cheapest, fastest, ...
    """
